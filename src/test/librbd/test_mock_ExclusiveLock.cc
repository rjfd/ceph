...
struct MockExclusiveLockWatcher : public MockWatcher {
  MockExclusiveLockWatcher(librados::IoCtx& ioctx) : MockWatcher(ioctx) {}
...
struct MockExclusiveLockImageCtx : public MockImageCtx {
  ...
  MockExclusiveLockWatcher *image_watcher;

  MockExclusiveLockImageCtx(ImageCtx &image_ctx) : MockImageCtx(image_ctx) {
    op_work_queue = image_ctx.op_work_queue;
    image_watcher = new MockExclusiveLockWatcher(this->md_ctx);
  }

  virtual ~MockExclusiveLockImageCtx() {
